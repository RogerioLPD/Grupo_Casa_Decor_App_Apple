...
class EnterpriseController {
  ...
  Future<void> fetchCompanies() async {
    ...
    final url = Uri.parse('https://apicasadecor.com/api/empresas/');
...
mockData() {
  return json.encode([
    ...
    },
    {
      "nome": "Dallak Home",
      "descricao":
          "Pioneira no ramo de decoração de ambientes e utilidades, a Dallak Home, está no mercado há 22 anos. Contamos com mais de 50 fornecedores renomados, em destaque as seguintes marcas: Wolff, Strauss, Sant James,velas Voluspa, Copa&amp;Cia, Cristais Bohemia, quadrosArtimage, cachepôs Bella Art, cristais murano São Marcos,plantas e flores permanentes Brilhance, entre outros.",
